		...
		if (!msg.$) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						m: $elm$time$Time$millisToPosix(
							$elm$time$Time$posixToMillis(model.m) - 1000)
					}),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						m: $author$project$Main$adjustTime(newTime)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$calculateDays = function (time) {
	return ((($elm$time$Time$posixToMillis(time) / 3600000) | 0) / 24) | 0;
};
var $elm$core$Basics$ge = _Utils_ge;
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$Main$calculateHours = function (time) {
	var hours = ($elm$time$Time$posixToMillis(time) / 3600000) | 0;
	return (hours >= 24) ? A2($elm$core$Basics$modBy, 24, hours) : hours;
};
var $author$project$Main$calculateMinutes = function (time) {
	var minutes = ($elm$time$Time$posixToMillis(time) / 60000) | 0;
	return (minutes >= 60) ? A2($elm$core$Basics$modBy, 60, minutes) : minutes;
};
var $author$project$Main$calculateSeconds = function (time) {
	var seconds = ($elm$time$Time$posixToMillis(time) / 1000) | 0;
	return (seconds >= 60) ? A2($elm$core$Basics$modBy, 60, seconds) : seconds;
};
...
var $author$project$Main$renderClock = function (section) {
	return (section <= 0) ? ('0' + $elm$core$String$fromInt(0)) : ((section >= 10) ? $elm$core$String$fromInt(section) : ('0' + $elm$core$String$fromInt(section)));
};
var $elm$html$Html$span = _VirtualDom_node('span');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$view = function (model) {
	var second = $author$project$Main$calculateSeconds(model.m);
	var minute = $author$project$Main$calculateMinutes(model.m);
	var hour = $author$project$Main$calculateHours(model.m);
	var day = $author$project$Main$calculateDays(model.m);
	return A2(
		$elm$html$Html$main_,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('time-section')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('time-count')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$renderClock(day))
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$renderClock(hour))
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$renderClock(minute))
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										$author$project$Main$renderClock(second))
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
